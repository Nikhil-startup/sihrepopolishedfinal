              ...
              <div className="h-44 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={trends} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <XAxis dataKey="day" tick={{ fontSize: 10, fill: '#aa9785' }} />
                    <YAxis tick={{ fontSize: 10, fill: '#aa9785' }} />
                    <Tooltip
                    ...
                    />
                    <Line type="monotone" dataKey="forecastedPrice" stroke="#d97706" strokeWidth={2.5} dot={{ r: 3 }} name={t('farmer.bestTime.forecastedMandi')} />
                    <Line type="monotone" dataKey="buyerDemandPrice" stroke="#ea580c" strokeWidth={2} strokeDasharray="4 4" name={t('farmer.bestTime.buyerDirect')} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            ) : (
